 ...
 */
public class BufferedEmittingPublisherSynchronized<T> implements Flow.Publisher<T> {

    private final AtomicReference<State> state = new AtomicReference<>(State.READY_TO_EMIT);
    private final ConcurrentLinkedQueue<T> buffer = new ConcurrentLinkedQueue<>();
    private final EmittingPublisherSynchronized<T> emitter = new EmittingPublisherSynchronized<>();
    ...
    protected BufferedEmittingPublisherSynchronized() {
    }

    /**
     * Create new {@link BufferedEmittingPublisherSynchronized}.
     *
     * @param <T> type of emitted item
     * @return new instance of BufferedEmittingPublisher
     */
    public static <T> BufferedEmittingPublisherSynchronized<T> create() {
        return new BufferedEmittingPublisherSynchronized<T>();
    }
     ...
     * {@link BufferedEmittingPublisherSynchronized#emit(Object)} throws {@link IllegalStateException} after calling fail.
     *
     ...
     * {@link BufferedEmittingPublisherSynchronized#emit(Object)} throws {@link IllegalStateException} after calling complete.
     */
     ...
     * Nothing else can be sent downstream after calling {@link BufferedEmittingPublisherSynchronized#completeNow()}.
     * {@link BufferedEmittingPublisherSynchronized#emit(Object)} throws {@link IllegalStateException} after calling completeNow.
     */
     ...
     * Returns {@code true} right after calling {@link BufferedEmittingPublisherSynchronized#completeNow()}
     * but after calling {@link BufferedEmittingPublisherSynchronized#complete()} returns
    ...
    private enum State {
        READY_TO_EMIT {
            ...
            @Override
            <T> int emit(BufferedEmittingPublisherSynchronized<T> publisher, T item) {
            ...
            @Override
            <T> void drain(final BufferedEmittingPublisherSynchronized<T> publisher) {
        ...
        abstract <T> int emit(BufferedEmittingPublisherSynchronized<T> publisher, T item);

        abstract <T> void drain(BufferedEmittingPublisherSynchronized<T> publisher);
