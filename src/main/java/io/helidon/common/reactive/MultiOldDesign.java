...
public interface MultiOldDesign<T> extends Multi<T> {
    ...
    /**
     * Transform item with supplied function and flatten resulting {@link java.util.concurrent.Flow.Publisher} to downstream.
     *
     * @param publisherMapper {@link java.util.function.Function} receiving item as parameter and returning {@link java.util.concurrent.Flow.Publisher}
    ...
    /**
     * Collect the items of this {@link Multi} instance into a {@link Single} of {@link java.util.List}.
     *
     * @return Single
     */
     ...
     * invoking {@link java.util.concurrent.Flow.Subscriber#onError(java.lang.Throwable)} when {@link java.util.concurrent.Flow.Publisher#subscribe(java.util.concurrent.Flow.Subscriber)} is called.
     *
     * @param <T>   item type
